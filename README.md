...
```ruby
gem 'itamae-plugin-recipe-mysql'
```
...
Or install it yourself as:
    ...
    $ gem install itamae-plugin-recipe-mysql
...
1. Fork it ( https://github.com/[my-github-username]/itamae-plugin-recipe-mysql/fork )
